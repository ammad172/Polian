...
using ShoppingCart.Services.Api.Services;
...
{
    option.UseSqlServer(builder.Configuration.GetConnectionString("Connection4"));
});
...
builder.Services.AddHttpClient("Coupon",
    m => m.BaseAddress = new Uri(builder.Configuration["ServiceUrls:CouponAPI"]));
